...
export async function fetchCars(filter: FilterProps) {
    ...
    const response = await fetch(`https://cars-by-api-ninjas.p.rapidapi.com/v1/cars?make=${filter.manufacturer}&model=${filter.model}&limit=${filter.limit}&fuel_type=${filter.fuel}`, {headers: headers});
